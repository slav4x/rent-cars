...
const slides: Slide[] = [
    { id: 1, img: "/img/car-item.jpg" },
    { id: 2, img: "/img/car-item.jpg" },
    { id: 3, img: "/img/car-item.jpg" },
    { id: 4, img: "/img/car-item.jpg" },
    { id: 5, img: "/img/car-item.jpg" },
    { id: 6, img: "/img/car-item.jpg" },
    { id: 7, img: "/img/car-item.jpg" },
    { id: 8, img: "/img/car-item.jpg" },
];
                ...
                <div className={styles.main}>
                            ...
                            <SplideTrack>
                                {slides.map((slide) => (
                                    <SplideSlide key={slide.id}>
                                        <img src={slide.img} alt={car.title} />
                                    </SplideSlide>
                                ))}
                            </SplideTrack>
                    ...
                    <div className={styles.block}>
                        ...
                        <div className={styles.description}>
                            <p>
                                Новый Mercedes-Benz Е-Класс седан — невероятно
                                динамичный, элегантный, роскошный автомобиль,
                                который отличается классическим дизайном,
                                высочайшим уровнем безопасности и комфортом
                                премиум-уровня. Благодаря превосходным ходовым
                                качествам обновлённого седана Вы испытаете
                                непревзойдённое удовольствие от процесса
                                вождения.
                            </p>
                            <p>
                                Mercedes-Benz Е-Класса создан, чтобы легко
                                и уверенно преодолеть любое расстояние
                                и доставить Вас в выбранный пункт назначения
                        ...
                        <div className={styles.spec}>
                            <div className={styles.specItem}>
                                <div className={styles.specIcon}>
                                    ...
                                    >
                                        <path
                                            d="M3.14286 0L0 12.8H4.71429L1.57143 24L11 9.6H6.28571L11 0H3.14286Z"
                                            fill="#C9A77F"
                                        />
                                    </svg>
                                </div>
                                ...
                                <SplideSlide>
                                    <div className={styles.conditionsCard}>
                                        ...
                                        <div className={styles.conditionsText}>
                                            Минимальный возраст водителя должен
                                            быть 23 года.
                                        </div>
                                    </div>
                                </SplideSlide>
