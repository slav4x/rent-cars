				...
				<div className={styles.list}>
					...
					>
						<div className={styles.card}>
							<Image src="img/steps-01.jpg" alt="" width={420} height={490} unoptimized={true} />
						...
						<div className={styles.card}>
							<Image src="img/steps-02.jpg" alt="" width={420} height={490} unoptimized={true} />
						...
						<div className={styles.card}>
							<Image src="img/steps-03.jpg" alt="" width={420} height={490} unoptimized={true} />
						...
						<div className={styles.card}>
							<Image src="img/steps-04.jpg" alt="" width={420} height={490} unoptimized={true} />
						...
						<div className={styles.card}>
							<Image src="img/steps-05.jpg" alt="" width={420} height={490} unoptimized={true} />
						...
						<div className={styles.card}>
							<Image src="img/steps-06.jpg" alt="" width={420} height={490} unoptimized={true} />
