...
const rules = [
    {
        title: "Допустимый возраст от 23 лет",
        text: "Минимальный возраст водителя для оформления аренды должен быть не менее 23 лет.",
        icon: (
            <svg
                width="20"
                height="20"
...
export default function AccountRulesPage() {
    return (
        <section className={styles.section}>
            <h1 className={view.title}>Правила бронирования</h1>

            <div className={styles.list}>
                {rules.map((rule) => (
                    <article key={rule.title} className={styles.item}>
                        <div className={styles.icon}>{rule.icon}</div>
